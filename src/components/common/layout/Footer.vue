      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          <div class="flex items-center mb-4">
            <h3 class="text-xl font-bold text-white">Bimbly</h3>
          </div>
          <p class="text-gray-300 mb-4 max-w-md">
            Connecting students with qualified tutors across Indonesia for personalized learning experiences.
          </p>
      ...
      <div class="mt-8 pt-8 border-t border-gray-800">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <p class="text-gray-400 text-sm">
            © {{ currentYear }} Bimbly. All rights reserved.
          </p>
...
export default defineComponent({
  ...
  setup() {
    ...
    const supportLinks = computed((): Link[] => [
