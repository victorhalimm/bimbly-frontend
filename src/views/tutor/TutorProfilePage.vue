<template>
  <div class="min-h-screen bg-gradient-to-b from-white to-blue-50">
    <div class="pt-24 pb-12 px-6 lg:px-12 max-w-7xl mx-auto">
...
export default {
  ...
  setup() {
    ...
    return { authStore, tutorStore, toast };
  },
  data() {
    return {
      loading: true,
  ...
  methods: {
    async loadProfile() {
      try {
        ...
        this.profile = this.tutorStore.currentUserProfile;
    ...
    async handleSubmit() {
      ...
      try {
        ...
        await this.tutorStore.updateProfile(payload);
