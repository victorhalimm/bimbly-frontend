...
import {
  getSubjectIconName as getSubjectIconNameFromConfig,
  getSubjectGradient as getSubjectGradientFromConfig,
  getSubjectBadgeClass as getSubjectBadgeClassFromConfig,
} from '@/config';
import {
  IconClipboardCheck,
  IconUser,
...
export default defineComponent({
  ...
  methods: {
    ...
    getSubjectIcon(subject: string | undefined): string {
      return getSubjectIconNameFromConfig(subject || '');
    },
    getSubjectGradient(subject: string | undefined): string {
      return getSubjectGradientFromConfig(subject || '');
    },
    getSubjectBadgeClass(subject: string | undefined): string {
      return getSubjectBadgeClassFromConfig(subject || '');
    },
